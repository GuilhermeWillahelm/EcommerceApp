namespace EcommerceApp.Server.Services.CartService
{
    public class CartService : ICartService
    {
        ...
        public async Task<ServiceResponse<bool>> AddToCart(CartItem cartItem)
        {
            ...
            var sameItem = await _context.CartItems.FirstOrDefaultAsync(ci => ci.ProductId == cartItem.ProductId && ci.ProductTypeId == cartItem.ProductTypeId
        ...
        public async Task<ServiceResponse<bool>> RemoveItemFromCart(int productId, int productTypeId)
        {
            ...
            if (dbCartItem == null)
            {
                ...
                { 
                    Data = false,
                    Success = false,
                    Message = "Cart iyem does not Exists."
                };
            }
